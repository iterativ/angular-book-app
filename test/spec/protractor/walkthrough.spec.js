describe('In walkthroug trough the Best-Practice App a user can', function() {
    ...
    var NotePage = function() {
      var author = element(by.model('vm.newNoteAuthor'));
      var notetitle = element(by.model('vm.newNoteTitle'));
      var text = element(by.model('vm.newNoteText'));
      var saveButton = element(by.buttonText('Save Note!'));
      ...
      this.setText = function() {
        text.sendKeys('some note about the book for testing purposes');
      };

      this.saveNote = function(author, title, text) {
    ...
    it('click on examples menu', function() {
        ...
        link.click().then(function() {
            ...
            a.click().then(function() {
                ...
                notePage.setAuthor('auth');
                notePage.setTitle('titu');
                notePage.setText('tegscht');
                notePage.saveNote();
